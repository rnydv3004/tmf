...
export default function Card({ passedDate = "" }: { passedDate: string }) {
    ...
    const fetchData = async () => {
      try {
        ...
        Object.entries(resdata.data).forEach(
          ([date, dateData]: [date: any, dateData: any]) => {
  ...
  return (
    <div className="grid grid-cols-3 h-full w-full bg-slate-300 overflow-hidden">
      ...
      {!transformedData ? (
        ...
        <ul className="col-span-1 p-2.5 flex flex-col gap-3 hover:overflow-y-auto">
            ...
            <li key={index}>
              ...
              >
                <div className="flex justify-between">
                  ...
                  <button className="text-white rounded-md font-medium py-2 px-3 min-w-[100px] text-xs bg-yellow-500 hover:bg-blue-600 ">
                    {item.status}
                  </button>
                </div>
          ...
          <div className=" bg-white gap-x-10 ga p-10 w-full h-fit rounded-md">
            <div className="flex gap-5 pb-5">
              <button
                ...
                className="text-white rounded-md py-2 px-3 min-w-[100px] text-xs bg-blue-700 hover:bg-blue-600"
              >
                Cancel
              </button>
              <button
...
export function NoAppointment() {
  return (
    <div className="relative bg-transparent bg-opacity-25 h-[70%] w-screen bottom-0 flex justify-center items-center">
